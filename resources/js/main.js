...
$(document).ready(function () {
    let defaultBirthYear = 'Birth Year'

    if (getCookie('COOKIE_AGE')) {
        defaultBirthYear = getCookie('COOKIE_AGE')
    ...
    $.dobPicker({
        yearSelector: '#dobyear', yearDefault: 'Birth Year', minimumAge: 10, maximumAge: 100
    });

    $.dobPicker({
        yearSelector: '#inscriptionBirthYear', yearDefault: defaultBirthYear, minimumAge: 10, maximumAge: 100
    });

    $.dobPicker({
        yearSelector: '#infoBirthYear', yearDefault: '1990', minimumAge: 18, maximumAge: 100
    });
